...
aos_vrs = {
    'laptop14': {'aspect':0.7087, 'opinion':0.5820, 'sentiment':0.5902},
    'rest14': {'aspect':0.7121, 'opinion':0.5685, 'sentiment':0.5911},
    'rest15': {'aspect':0.6905, 'opinion':0.5448, 'sentiment':0.5414},
    'rest16': {'aspect':0.6998, 'opinion':0.5762, 'sentiment':0.5861},
}
...
if not os.path.exists(path_w):  
    ...
    with open(path_w, 'r', encoding='utf-8') as f_r:
        pre_results_len = len(f_r.read().strip().split('\n'))
